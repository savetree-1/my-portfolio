...
const FullpageProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  useEffect(() => {
    ...
    about.current = gsap
      ...
      // Start with element 1 visible
      .set(".left .animate__this1", { y: "0%", opacity: 1 })
      ...
      // Element 1 moves out, Element 2 moves in
      .to(".left .animate__this1", { y: "-140%", opacity: 0, duration: 0.9, delay: 1.7 })
      .to(".left .animate__this2", { y: "0%", opacity: 1, duration: 0.9 }, "-=0.9")
      // Element 2 moves out, Element 3 moves in
      .to(".left .animate__this2", { y: "-140%", opacity: 0, duration: 0.9, delay: 1.7 })
      .to(".left .animate__this3", { y: "0%", opacity: 1, duration: 0.9 }, "-=0.9")
      // Element 3 moves out, Element 4 moves in
      .to(".left .animate__this3", { y: "-140%", opacity: 0, duration: 0.9, delay: 1.7 })
      .to(".left .animate__this4", { y: "0%", opacity: 1, duration: 0.9 }, "-=0.9")
      // Element 4 moves out, Element 5 moves in
      .to(".left .animate__this4", { y: "-140%", opacity: 0, duration: 0.9, delay: 1.7 })
      .to(".left .animate__this5", { y: "0%", opacity: 1, duration: 0.9 }, "-=0.9")
      // Element 5 moves out, Element 1 moves in (completing the loop)
      .to(".left .animate__this5", { y: "-140%", opacity: 0, duration: 0.9, delay: 1.7 })
      .to(".left .animate__this1", { y: "0%", opacity: 1, duration: 0.9 }, "-=0.9");
